...
void outputTask(ConnectionHandler& handler,boost::thread& inputThread){
    while(1){
...
int main (int argc, char *argv[]) {
    ...
    boost::thread outputThread(&outputTask,boost::ref(connectionHandler),boost::ref(inputThread));
    inputThread.join();
    outputThread.join();
