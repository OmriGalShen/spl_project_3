...
public class Tests implements Runnable {
    ...
    public String testMyCourses() {
        ...
        System.out.println("In testMyCourses user courses:");
        System.out.println(myCourses);
        System.out.println("In testMyCourses needed courses:");
    ...
    private ArrayList<Course> registerToCourses(CommandProcessor commandProcessor){
        ...
        for (Course course:courses1){
            System.out.println("Ron Tests: Register to "+course.getCourseNum());
    ...
    public void generateCourses(){
        try {
            ...
            for (int i = 0; i < numCoursesToGenerate; i++) {
                int generatedCourseNum = ((int) (Math.random() * 50) + 10);
